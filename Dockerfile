...
FROM mcr.microsoft.com/dotnet/aspnet:8.0-bookworm-slim-arm64v8, 8.0.3-bookworm-slim AS base
WORKDIR /app
...
FROM mcr.microsoft.com/dotnet/sdk:8.0-bookworm-slim-arm64v8, 8.0.3-bookworm-slim AS build
WORKDIR /src
